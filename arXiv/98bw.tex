...
\begin{document}
\title{Hot gas around SN~1998bw - Inferring the progenitor from its environment\thanks{Based on observations collected at the ESO Paranal observatory under ESO programme 095.D-0172(A)}}
...
$T_{e}$(\siii) ($10^4$~K)$^{\mathrm{(b)}}$ & $\cdots$ & $1.24\pm 0.18$ & $0.94\pm 0.02$\\
$T_{e}$(\oiii) ($10^4$~K)$^{\mathrm{(b,c)}}$ & $\cdots$ & $1.29\pm 0.18$ & $1.05\pm 0.02$\\
...
$\oh$\, ($T_{e}$)$^{\mathrm{(c)}}$ & $\cdots$ &  $8.09\pm0.15$ & $8.36\pm0.07$ \\
