...
\abstract{Spatially-resolved spectroscopy of the environment of explosive transients carries detailed information about the physical properties of the stellar population that gave rise to the explosion, and thus the progenitor itself. Here, we present new observations of ESO184-G82, the galaxy hosting the archetype of the GRB/SN connection, GRB~980425/SN~1998bw, obtained with the integral-field spectrograph MUSE. They yield detailed maps of emission-line strength for various nebular lines, as well as physical parameters like dust extinction, stellar age, and oxygen abundance on spatial scales of 100 pc. The immediate environment of GRB~980425 is young (5~--~8\,Myr) and consistent with a mildly-extinguished ($A_V\sim0.1\,\mathrm{mag}$) progenitor of zero-age main-sequence mass between 25\,M$_{\odot}$ and 40\,M$_{\odot}$ and oxygen abundance $\oh\sim8.1$ ($Z\sim0.25\,\mathrm{Z}_\odot$). This value is somewhat lower than the one of a prominent nearby \hii-region ($\oh\sim8.4$) and an integrated measurement of the whole galaxy ($\oh\sim8.3$). We demonstrate that simple empirical strong-line methods based on \oiii\,and/or \nii\, are inadequate to produce accurate maps of oxygen abundance at the level of detail of our MUSE observation because these methods over-/underestimate $\oh$\,at low/high ionization parameter. The metallicity gradient in ESO184-G82 is -0.06\,dex\,kpc$^{-1}$, indicating that the typical offsets of at most few kpc for cosmological GRBs have a small impact for high-redshift measurements on average. Similarly, the GRB/SN site spectrum returns broadly comparable physical parameters than those inferred from an unresolved spectrum, which is typically obtained for high-redshift galaxies.}
...
\tablefoot{
\tablefoottext{a}{Derived through the ratio of the \sii($\lambda\lambda6716,6731$) doublet.}
